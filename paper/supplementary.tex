...
Applying real projection $\operatorname{Re}(\cdot)$ both at the reread estimate $\hat{\mathbf{v}}_j \leftarrow \operatorname{Re}(\hat{\mathbf{v}}_j)$ and at the final query readout $\mathbf{r}_j = \operatorname{Re}(\mathbf{w}_j^H \M' / D)$ projects out the imaginary component of the phase differences.
\begin{itemize}
